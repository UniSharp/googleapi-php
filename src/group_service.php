...
namespace google\monitoring\v3 {
  ...
  class GroupServiceClient extends \Grpc\BaseStub {
    ...
    public function DeleteGroup(\google\monitoring\v3\DeleteGroupRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/google.monitoring.v3.GroupService/DeleteGroup', $argument, '\google\protobuf\Empty::deserialize', $metadata, $options);
    }
    /**
