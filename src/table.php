...
//   Date: 2017-06-13 04:23:41

namespace google\bigtable\admin\v2\Table {
...
namespace google\bigtable\admin\v2\Table {
  ...
  class View extends \DrSlump\Protobuf\Enum {
...
namespace google\bigtable\admin\v2\Table {
  ...
  class ColumnFamiliesEntry extends \DrSlump\Protobuf\Message {
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'google.bigtable.admin.v2.Table.ColumnFamiliesEntry');
     ...
     * Clear <key> value
     *
     * @return \google\bigtable\admin\v2\Table\ColumnFamiliesEntry
     */
     ...
     * @return \google\bigtable\admin\v2\Table\ColumnFamiliesEntry
     */
    public function setValue(\google\bigtable\admin\v2\ColumnFamily $value){
...
namespace google\bigtable\admin\v2 {
  ...
  class Table extends \DrSlump\Protobuf\Message {
    ...
    /**  @var \google\bigtable\admin\v2\Table\ColumnFamiliesEntry[]  */
    public $column_families = array();
    
    /**  @var int - \google\bigtable\admin\v2\Table\TimestampGranularity */
    ...
    public static function descriptor()
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'google.bigtable.admin.v2.Table');
      ...
      $f->reference = '\google\bigtable\admin\v2\Table\ColumnFamiliesEntry';
      $descriptor->addField($f);
      ...
      $f->rule      = \DrSlump\Protobuf::RULE_OPTIONAL;
      $f->reference = '\google\bigtable\admin\v2\Table\TimestampGranularity';
      $descriptor->addField($f);
     ...
     *
     * @param \google\bigtable\admin\v2\Table\ColumnFamiliesEntry $value
     * @return \google\bigtable\admin\v2\Table
     */
    public function setColumnFamilies(\google\bigtable\admin\v2\Table\ColumnFamiliesEntry $value, $idx = NULL){
     ...
     * @return \google\bigtable\admin\v2\Table
     */
    public function addColumnFamilies(\google\bigtable\admin\v2\Table\ColumnFamiliesEntry $value){
     ...
     *
     * @return int - \google\bigtable\admin\v2\Table\TimestampGranularity
     */
     ...
     *
     * @param int - \google\bigtable\admin\v2\Table\TimestampGranularity $value
     * @return \google\bigtable\admin\v2\Table
     */
...
namespace google\bigtable\admin\v2 {
  ...
  class ColumnFamily extends \DrSlump\Protobuf\Message {
    ...
    /**  @var \google\bigtable\admin\v2\GcRule */
    public $gc_rule = null;
    ...
    public static function descriptor()
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'google.bigtable.admin.v2.ColumnFamily');

      // OPTIONAL MESSAGE gc_rule = 1
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 1;
      $f->name      = "gc_rule";
      $f->type      = \DrSlump\Protobuf::TYPE_MESSAGE;
      $f->rule      = \DrSlump\Protobuf::RULE_OPTIONAL;
      $f->reference = '\google\bigtable\admin\v2\GcRule';
      $descriptor->addField($f);
     ...
     * Set <gc_rule> value
     *
     * @param \google\bigtable\admin\v2\GcRule $value
     * @return \google\bigtable\admin\v2\ColumnFamily
     */
    public function setGcRule(\google\bigtable\admin\v2\GcRule $value){
      return $this->_set(1, $value);
    }
  }
}

namespace google\bigtable\admin\v2\GcRule {
  ...
  class Intersection extends \DrSlump\Protobuf\Message {
    ...
    public static function descriptor()
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'google.bigtable.admin.v2.GcRule.Intersection');
     ...
     * @return \google\bigtable\admin\v2\GcRule\Intersection
     */
    public function setRules(\google\bigtable\admin\v2\GcRule $value, $idx = NULL){
     ...
     * @return \google\bigtable\admin\v2\GcRule\Intersection
     */
    public function addRules(\google\bigtable\admin\v2\GcRule $value){
...
namespace google\bigtable\admin\v2\GcRule {
  ...
  class Union extends \DrSlump\Protobuf\Message {
    ...
    public static function descriptor()
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'google.bigtable.admin.v2.GcRule.Union');
...
namespace google\bigtable\admin\v2 {
  ...
  class GcRule extends \DrSlump\Protobuf\Message {
    ...
    /**  @var \google\bigtable\admin\v2\GcRule\Intersection */
    public $intersection = null;
    
    /**  @var \google\bigtable\admin\v2\GcRule\Union */
    public $union = null;
    ...
    public static function descriptor()
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'google.bigtable.admin.v2.GcRule');
      ...
      $f->type      = \DrSlump\Protobuf::TYPE_MESSAGE;
      $f->rule      = \DrSlump\Protobuf::RULE_OPTIONAL;
      $f->reference = '\google\bigtable\admin\v2\GcRule\Intersection';
      $descriptor->addField($f);
      ...
      $f->type      = \DrSlump\Protobuf::TYPE_MESSAGE;
      $f->rule      = \DrSlump\Protobuf::RULE_OPTIONAL;
      $f->reference = '\google\bigtable\admin\v2\GcRule\Union';
      $descriptor->addField($f);
     ...
     *
     * @param \google\bigtable\admin\v2\GcRule\Intersection $value
     * @return \google\bigtable\admin\v2\GcRule
     */
    public function setIntersection(\google\bigtable\admin\v2\GcRule\Intersection $value){
     ...
     * Set <union> value
     *
     * @param \google\bigtable\admin\v2\GcRule\Union $value
     * @return \google\bigtable\admin\v2\GcRule
     */
    public function setUnion(\google\bigtable\admin\v2\GcRule\Union $value){
      return $this->_set(4, $value);
    }
  }
}
