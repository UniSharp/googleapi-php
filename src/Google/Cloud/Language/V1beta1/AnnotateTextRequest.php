 ...
 * </pre>
 *
 * Protobuf type <code>google.cloud.language.v1beta1.AnnotateTextRequest</code>
 */
class AnnotateTextRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Language\V1beta1\AnnotateTextRequest_Features::class);
        $this->features = $var;
    }
