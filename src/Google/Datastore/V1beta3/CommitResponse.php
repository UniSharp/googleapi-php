 ...
 * </pre>
 *
 * Protobuf type <code>google.datastore.v1beta3.CommitResponse</code>
 */
class CommitResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Datastore\V1beta3\MutationResult::class);
