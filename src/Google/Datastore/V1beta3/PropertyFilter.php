 ...
 * </pre>
 *
 * Protobuf type <code>google.datastore.v1beta3.PropertyFilter</code>
 */
class PropertyFilter extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \Google\Datastore\V1beta3\PropertyReference::class);
        $this->property = $var;
    }
    ...
    {
        GPBUtil::checkEnum($var, \Google\Datastore\V1beta3\PropertyFilter_Operator::class);
        $this->op = $var;
    }
    ...
    {
        GPBUtil::checkMessage($var, \Google\Datastore\V1beta3\Value::class);
        $this->value = $var;
    }
