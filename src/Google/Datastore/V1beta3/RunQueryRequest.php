 ...
 * </pre>
 *
 * Protobuf type <code>google.datastore.v1beta3.RunQueryRequest</code>
 */
class RunQueryRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \Google\Datastore\V1beta3\PartitionId::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Datastore\V1beta3\ReadOptions::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Datastore\V1beta3\Query::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Datastore\V1beta3\GqlQuery::class);
