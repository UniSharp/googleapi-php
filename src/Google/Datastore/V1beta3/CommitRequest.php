 ...
 * </pre>
 *
 * Protobuf type <code>google.datastore.v1beta3.CommitRequest</code>
 */
class CommitRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Datastore\V1beta3\CommitRequest_Mode::class);
        $this->mode = $var;
    }
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Datastore\V1beta3\Mutation::class);
        $this->mutations = $arr;
    }
