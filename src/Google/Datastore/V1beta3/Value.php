 ...
 * </pre>
 *
 * Protobuf type <code>google.datastore.v1beta3.Value</code>
 */
class Value extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \Google\Datastore\V1beta3\Entity::class);
    ...
    {
        GPBUtil::checkMessage($var, \Google\Datastore\V1beta3\ArrayValue::class);
