 ...
 * </pre>
 *
 * Protobuf type <code>google.datastore.v1beta3.QueryResultBatch</code>
 */
class QueryResultBatch extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Datastore\V1beta3\EntityResult_ResultType::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Datastore\V1beta3\EntityResult::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Datastore\V1beta3\QueryResultBatch_MoreResultsType::class);
