...
namespace Google\Spanner\Admin\Database\V1 {
  ...
  class DatabaseAdminClient extends \Grpc\BaseStub {
     ...
     * @param \Google\Spanner\Admin\Database\V1\ListDatabasesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function ListDatabases(\Google\Spanner\Admin\Database\V1\ListDatabasesRequest $argument,
      $metadata = [], $options = []) {
      return $this->_simpleRequest('/google.spanner.admin.database.v1.DatabaseAdmin/ListDatabases',
      $argument,
      ['\Google\Spanner\Admin\Database\V1\ListDatabasesResponse', 'decode'],
      $metadata, $options);
    }
     ...
     * @param \Google\Spanner\Admin\Database\V1\CreateDatabaseRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function CreateDatabase(\Google\Spanner\Admin\Database\V1\CreateDatabaseRequest $argument,
      $metadata = [], $options = []) {
     ...
     * @param \Google\Spanner\Admin\Database\V1\GetDatabaseRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function GetDatabase(\Google\Spanner\Admin\Database\V1\GetDatabaseRequest $argument,
      $metadata = [], $options = []) {
      return $this->_simpleRequest('/google.spanner.admin.database.v1.DatabaseAdmin/GetDatabase',
      $argument,
      ['\Google\Spanner\Admin\Database\V1\Database', 'decode'],
      $metadata, $options);
    }
     ...
     * @param \Google\Spanner\Admin\Database\V1\UpdateDatabaseDdlRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function UpdateDatabaseDdl(\Google\Spanner\Admin\Database\V1\UpdateDatabaseDdlRequest $argument,
      $metadata = [], $options = []) {
     ...
     * @param \Google\Spanner\Admin\Database\V1\DropDatabaseRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function DropDatabase(\Google\Spanner\Admin\Database\V1\DropDatabaseRequest $argument,
      $metadata = [], $options = []) {
     ...
     * @param \Google\Spanner\Admin\Database\V1\GetDatabaseDdlRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function GetDatabaseDdl(\Google\Spanner\Admin\Database\V1\GetDatabaseDdlRequest $argument,
      $metadata = [], $options = []) {
      return $this->_simpleRequest('/google.spanner.admin.database.v1.DatabaseAdmin/GetDatabaseDdl',
      $argument,
      ['\Google\Spanner\Admin\Database\V1\GetDatabaseDdlResponse', 'decode'],
      $metadata, $options);
    }
