...
namespace Google\Pubsub\V1 {
  ...
  class SubscriberClient extends \Grpc\BaseStub {
     ...
     * @param array $options call options
     */
    public function UpdateSubscription(\Google\Pubsub\V1\UpdateSubscriptionRequest $argument,
      $metadata = [], $options = []) {
     ...
     * @param \Google\Pubsub\V1\ListSnapshotsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function ListSnapshots(\Google\Pubsub\V1\ListSnapshotsRequest $argument,
      $metadata = [], $options = []) {
      return $this->_simpleRequest('/google.pubsub.v1.Subscriber/ListSnapshots',
      $argument,
      ['\Google\Pubsub\V1\ListSnapshotsResponse', 'decode'],
      $metadata, $options);
    }
     ...
     * Note that for REST API requests, you must specify a name in the request.
     * @param \Google\Pubsub\V1\CreateSnapshotRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
     ...
     * @param \Google\Pubsub\V1\DeleteSnapshotRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function DeleteSnapshot(\Google\Pubsub\V1\DeleteSnapshotRequest $argument,
      $metadata = [], $options = []) {
     ...
     * @param \Google\Pubsub\V1\SeekRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function Seek(\Google\Pubsub\V1\SeekRequest $argument,
      $metadata = [], $options = []) {
      return $this->_simpleRequest('/google.pubsub.v1.Subscriber/Seek',
      $argument,
      ['\Google\Pubsub\V1\SeekResponse', 'decode'],
      $metadata, $options);
    }
