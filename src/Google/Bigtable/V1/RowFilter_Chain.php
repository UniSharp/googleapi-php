 ...
 * </pre>
 *
 * Protobuf type <code>google.bigtable.v1.RowFilter.Chain</code>
 */
class RowFilter_Chain extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Bigtable\V1\RowFilter::class);
        $this->filters = $var;
    }
