 ...
 * </pre>
 *
 * Protobuf type <code>google.bigtable.v1.ReadModifyWriteRowRequest</code>
 */
class ReadModifyWriteRowRequest extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Bigtable\V1\ReadModifyWriteRule::class);
        $this->rules = $var;
    }
