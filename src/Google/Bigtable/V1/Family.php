 ...
 * </pre>
 *
 * Protobuf type <code>google.bigtable.v1.Family</code>
 */
class Family extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Bigtable\V1\Column::class);
        $this->columns = $arr;
    }
