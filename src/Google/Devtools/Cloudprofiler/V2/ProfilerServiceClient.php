...
namespace Google\Devtools\Cloudprofiler\V2 {
  ...
  // ProfilerService provides API for recording the profiling data from profiling
  // agents running as part of a GCP deployment being profiled or from an offline
  // provider of profiling data.
  //
  // General guidelines:
