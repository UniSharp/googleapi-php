...
namespace google\datastore\v1beta3 {
  ...
  class DatastoreClient extends \Grpc\BaseStub {
    ...
    /**
     * @param google\datastore\v1beta3\LookupRequest $input
     */
    public function Lookup(\google\datastore\v1beta3\LookupRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/google.datastore.v1beta3.Datastore/Lookup', $argument, '\google\datastore\v1beta3\LookupResponse::deserialize', $metadata, $options);
    }
    /**
     * @param google\datastore\v1beta3\RunQueryRequest $input
     */
    public function RunQuery(\google\datastore\v1beta3\RunQueryRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/google.datastore.v1beta3.Datastore/RunQuery', $argument, '\google\datastore\v1beta3\RunQueryResponse::deserialize', $metadata, $options);
    }
    /**
     * @param google\datastore\v1beta3\BeginTransactionRequest $input
     */
    public function BeginTransaction(\google\datastore\v1beta3\BeginTransactionRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/google.datastore.v1beta3.Datastore/BeginTransaction', $argument, '\google\datastore\v1beta3\BeginTransactionResponse::deserialize', $metadata, $options);
    }
    /**
     * @param google\datastore\v1beta3\CommitRequest $input
     */
    public function Commit(\google\datastore\v1beta3\CommitRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/google.datastore.v1beta3.Datastore/Commit', $argument, '\google\datastore\v1beta3\CommitResponse::deserialize', $metadata, $options);
    }
    /**
     * @param google\datastore\v1beta3\RollbackRequest $input
     */
    public function Rollback(\google\datastore\v1beta3\RollbackRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/google.datastore.v1beta3.Datastore/Rollback', $argument, '\google\datastore\v1beta3\RollbackResponse::deserialize', $metadata, $options);
    }
    /**
     * @param google\datastore\v1beta3\AllocateIdsRequest $input
     */
    public function AllocateIds(\google\datastore\v1beta3\AllocateIdsRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/google.datastore.v1beta3.Datastore/AllocateIds', $argument, '\google\datastore\v1beta3\AllocateIdsResponse::deserialize', $metadata, $options);
    }
  }
}
